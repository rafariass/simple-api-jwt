...
Este proyecto utiliza una variable de entorno llamada `JWT_SECRET` para firmar y verificar el token JWT. Asegúrate de definir esta variable en tu archivo `.env` antes de ejecutar la aplicación.